package it.test1.jhipster.config.timezone;

import it.test1.jhipster.TestApp;
import it.test1.jhipster.repository.timezone.DateTimeWrapper;
import it.test1.jhipster.repository.timezone.DateTimeWrapperRepository;
