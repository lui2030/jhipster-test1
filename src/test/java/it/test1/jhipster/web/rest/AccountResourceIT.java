...
import it.test1.jhipster.config.Constants;
import it.test1.jhipster.domain.Authority;
import it.test1.jhipster.domain.User;
import it.test1.jhipster.repository.AuthorityRepository;
import it.test1.jhipster.repository.UserRepository;
import it.test1.jhipster.security.AuthoritiesConstants;
import it.test1.jhipster.service.MailService;
import it.test1.jhipster.service.UserService;
import it.test1.jhipster.service.dto.PasswordChangeDTO;
import it.test1.jhipster.service.dto.UserDTO;
import it.test1.jhipster.web.rest.errors.ExceptionTranslator;
import it.test1.jhipster.web.rest.vm.KeyAndPasswordVM;
import it.test1.jhipster.web.rest.vm.ManagedUserVM;
